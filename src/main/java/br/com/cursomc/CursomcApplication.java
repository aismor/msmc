...
import br.com.cursomc.repositories.Enderecoepository;
...
public class CursomcApplication implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		cli1.getTelefones().addAll(Arrays.asList("55555555", "66666666"));

		Endereco e1 = new Endereco(null, "Rua Flores", "300", "Apto 303", "Jardim", "38220834", cli1, c1);
		Endereco e2 = new Endereco(null, "Av Matos", "105", "Sala 800", "Centro", "38221114", cli1, c2);
		...
		Pedido ped1 = new Pedido(null, sdf.parse("30/09/2020 10:17"), cli1, e1);
		Pedido ped2 = new Pedido(null, sdf.parse("10/10/2020 08:17"), cli1, e2);
